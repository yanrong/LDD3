...
/* Tile the sequence operators up. */
...
/* Ceate a set of file operations for our proc file */
...
static void scull_remove_proc(void)
{
    ...
    remove_proc_entry("scullmem", NULL /* parnt */);
...
int scull_open(struct inode *inode, struct file *filp)
{
    ...
    /* now trim to 0 the length of the device if open is write-only */
                ...
                loff_t *f_pos)
{
    ...
    int itemsize = quantum * qset; /* how many byte in the listitem */
