...
#ifdef SCULLD_USE_PROC /* don't waste space if unsed */

/*
 * The proc filesystem: function to read and entry
 */
/* FIXME: Do we need this here??  It be ugly  */
int sculld_read_procmem(struct seq_file *s, void *v)
{
    int i, j, order, qset;
                ...
                loff_t *f_pos)
{
    ...
    struct sculld_dev *dptr; /* the first listitem */
...
long sculld_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    case SCULLD_IOCSORDER: /* Set: arg point to the value */
    ...
    case SCULLD_IOCQORDER: /* Query: return it (it is positive) */
        return sculld_order;
    ...
    case SCULLD_IOCHORDER: /*sHift: like Tell and Query*/
        tmp = sculld_order;
        sculld_order = arg;
        return tmp;
