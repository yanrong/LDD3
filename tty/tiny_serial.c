...
static void tiny_timer(unsigned long data)
{
	...
	* this dosen't actually push the unless tty->low_latency is set
	*/
...
static void tiny_config_port(struct uart_port *port, int flag)
{
}

static int tiny_verify_port(struct uart_port *port, struct serial_struct *serial)
{
	return 0;
}
